 ...
 * @author HP
 */
public class ToletReview extends HttpServlet {
    ...
    int i=0;
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("update toletregistration set status='approved' where registry='"+registry+"'");
